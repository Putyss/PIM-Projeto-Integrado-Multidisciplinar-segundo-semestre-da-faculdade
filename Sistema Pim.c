...
int CadastroReuniao(FichaReuniao *q, int n, int j){
    ...
    do{
        ...
        scanf("%s", &(q+j)->hora);
        fflush(stdin);
        printf("Informe o motivo da reunião: ");
        gets((q+j)->motivo);
        j++;
        printf("\n----------------------------------------------------------\n\n");
...
int CadastroFuncionario(funcionario *r, int m, int y){
    ...
    do{
        ...
        scanf("%i", &(r+y)->ano);
        fflush(stdin);
        printf("Informe o número de Registro do(a) %s: ", (r+y)->nome);
        gets((r+y)->registro);
        y++;
        printf("\n----------------------------------------------------------\n\n");
...
int BuscarDocVisita(FichaVisita *p, int n, int i, int opcao){
    ...
    do{
        ...
        if (achou == false){
            ...
            printf("\nPara encerrar o programa digite (exit). Para buscar documento novamente aperte qualquer tecla.\n");
            fflush(stdin);
            gets(sair);
            strlwr(sair);
            system("cls");
	...
	}while((achou == false) && (strcmp(sair, "exit") != 0));
